...
import com.juicew.juicepicbackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.juicew.juicepicbackend.manager.FileManager;
import com.juicew.juicepicbackend.manager.upload.FilePictureUpload;
import com.juicew.juicepicbackend.manager.upload.PictureUploadTemplate;
import com.juicew.juicepicbackend.manager.upload.UrlPictureUpload;
...
import com.juicew.juicepicbackend.utils.ColorSimilarUtils;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        //更新空间的的使用额度，未实现更新图片时同时删除原图片和释放额度
    ...
    //异步执行，可以取配置一下默认线程池，springboot使用的默认线程池是Executors的线程池
    @Async
    @Override
